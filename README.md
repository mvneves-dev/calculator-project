[README.md](https://github.com/user-attachments/files/25848904/README.md)
# Calculadora Simples

Uma calculadora web minimalista e funcional.
...
- `calculadora.js` - Versão em JavaScript (Node.js)

## Requisitos

Nenhum! Basta abrir o HTML no navegador.
